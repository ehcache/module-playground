...
public abstract class Jsr107Parser<T> implements Parser<T> {

  private static final URI NAMESPACE = URI.create("http://www.ehcache.org/v3/jsr107");

  @Override
  public Map<URI, Supplier<Source>> getSchema() {
    return singletonMap(NAMESPACE, () -> new StreamSource(getClass().getResourceAsStream("/ehcache-107-ext.xsd")));
  }
